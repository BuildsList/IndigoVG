...
/mob/living/carbon/human/wearing_wiz_garb()
	if(!is_wiz_garb(src.wear_suit))
		src << "<span class='indigo'>I don't feel strong enough without my robe.</span>"
		return 0
	if(!is_wiz_garb(src.shoes))
		src << "<span class='indigo'>I don't feel strong enough without my sandals.</span>"
		return 0
	if(!is_wiz_garb(src.head))
		src << "<span class='indigo'>I don't feel strong enough without my hat.</span>"
		return 0
	return 1
