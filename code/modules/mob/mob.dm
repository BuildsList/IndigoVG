...
/mob/proc/print_flavor_text()
	if(flavor_text)
		...
		if(length(msg) <= 32)
			return "<font color='#ffa000'><b>[sanitize(msg)]</b></font>"
		else
			return "<font color='#ffa000'><b>[sanitize(copytext(msg, 1, 32))]...<a href='?src=\ref[src];flavor_text=more'>More</a></b></font>"
