...
/mob/living/simple_animal/hostile/necro/New(loc, mob/living/Owner, datum/mind/Controller)
	...
	if(Controller)
		mind = Controller
		ckey = ckey(mind.key)
		src << "<big><span class='indigo'>You have been risen from the dead by your new master, [Owner]. Do his bidding so long as he lives, for when he falls so do you.</span></big>"
