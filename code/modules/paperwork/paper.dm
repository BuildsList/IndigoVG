...
/obj/item/weapon/paper/Topic(href, href_list)
	...
	if(href_list["write"])
		...
		//var/t = strip_html_properly(input(usr, "What text do you wish to add to " + (id=="end" ? "the end of the paper" : "field "+id) + "?", "[name]", null),8192) as message
		//var/t =  strip_html_properly(input("Enter what you want to write:", "Write", null, null)  as message, MAX_MESSAGE_LEN)
